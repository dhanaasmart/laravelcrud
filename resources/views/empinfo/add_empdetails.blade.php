...
@endif
  ...
  <form class="form-horizontal" action="{{url('add-emp')}}" method="POST" enctype="multipart/form-data">
    @csrf
   
    <div class="form-group">
      <label class="control-label col-sm-2" for="empid">Employee ID :</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="empid" placeholder="Enter Employee ID" name="empid" value="{{old('empid')}}" />
